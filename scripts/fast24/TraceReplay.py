...
OUTPUT_DIR_PATH = Path("/dev/shm")
OUTPUT_DIR_PATH.mkdir(exist_ok=True, parents=True)
POWER_OUT_FILE_PATH = OUTPUT_DIR_PATH.joinpath("power.csv")
STDOUT_FILE_PATH = OUTPUT_DIR_PATH.joinpath("stdout.dump")
STDERR_FILE_PATH = OUTPUT_DIR_PATH.joinpath("stderr.dump")
CONFIG_FILE_PATH = OUTPUT_DIR_PATH.joinpath("config.json")
SERVER_USAGE_FILE_PATH = OUTPUT_DIR_PATH.joinpath("usage.csv")
STAT_FILE_PATH = OUTPUT_DIR_PATH.joinpath("stat_0.out")
TS_STAT_FILE_PATH = OUTPUT_DIR_PATH.joinpath("tsstat_0.out")
